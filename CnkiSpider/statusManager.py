...
class StatusManager():
    def __init__(self, type: SpiderTypeEnum):
        self.srcCodeFile = 'dataSrc/code.txt'
    ...
    def getLastDateAndCode(self):
        ...
        '''
        # TODO 读取数据库
        conn = pymysql.connect(host="10.1.13.142", user="root", passwd="123456", database="ZhiWangSpider")
        cursor = conn.cursor()
    ...
    def getNextDateAndCode(self):
        ...
        if lastDate is None or lastCode is None:
            return None
